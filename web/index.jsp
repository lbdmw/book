...
<head>
	...
	<!-- Google web fonts
	============================================ -->
	<link href='http://fonts.useso.com/css?family=Libre+Baskerville:400,400italic,700' rel='stylesheet' type='text/css'>
	<link href='http://fonts.useso.com/css?family=Playfair+Display:400,400italic,700italic,900italic,900,700' rel='stylesheet' type='text/css'>
...
<div class="header-bottom">
	<div class="container">
		<div class="row">
			<!-- Header Logo -->
			<div class="logo col-md-2 col-sm-4 col-xs-5"><a href="index.jsp"><img src="img/logo.png" alt="logo" /></a></div>
			<!-- Main Menu -->
			<div class="main-menu col-md-7 hidden-sm hidden-xs">
				<nav>
					<ul>
						...
						<li><a href="index.jsp">商店</a>
							<!-- Mega Menu -->
							<%--<div class="mega-menu mega-menu1">
								<div class="megamenu-column megamenu-column1">
									<ul>
										<li><a href="index.jsp">Accessories</a></li>
										<li><a href="index.jsp">Leather</a></li>
										<li><a href="index.jsp">Sunglasses</a></li>
										<li><a href="index.jsp">Belts</a></li>
										<li><a href="index.jsp">Rings</a></li>
										<li><a href="index.jsp">Sweaters</a></li>
										<li><a href="index.jsp">Bags & Persess</a></li>
									</ul>
								</div>
								<div class="megamenu-column megamenu-column1">
									<ul>
										<li><a href="index.jsp">Men's Wear</a></li>
										<li><a href="index.jsp">Shirts & tops</a></li>
										<li><a href="index.jsp">Dresses</a></li>
										<li><a href="index.jsp">Swimwear</a></li>
										<li><a href="index.jsp">Jeans</a></li>
								...
								<div class="megamenu-column megamenu-column1">
									<ul>
										<li><a href="index.jsp">WoMen's Wear</a></li>
										<li><a href="index.jsp">Party Dress</a></li>
										<li><a href="index.jsp">T-Shirt</a></li>
										<li><a href="index.jsp">Jeans & Trousers</a></li>
										<li><a href="index.jsp">Jacket & Coats</a></li>
										<li><a href="index.jsp">Sweaters</a></li>
										<li><a href="index.jsp">Nightwear</a></li>
									</ul>
								</div>
								<div class="megamenu-column megamenu-column2">
									<a href="#" class="menu-image"><img src="img/menu-image.png" alt="" /></a>
								</div>
							</div>--%>
						</li>
						<%--<li><a href="#">评价本店</a>
							...
							<ul class="sub-menu">
								...
								<li><a href="index.jsp">Shop</a>
									<ul class="sub-menu-2">
										<li><a href="index.jsp">Shop Left Sidebar</a></li>
...
<%--						<li><a href="blog.html">Blog</a></li>--%>
						<li><a href="blog.html">看看书友</a></li>
						<li><a href="contact.html">评价本店</a></li>
					</ul>
				</nav>
			</div>
			<!-- Header Search & Cart -->
			<div class="search-cart col-md-3 col-md-offset-0 col-sm-5 col-sm-offset-3 col-xs-7">
				...
				<div class="header-cart float-right">
					...
					<div class="headercart-wrapper">
						...
						<ul class="products">
							<li>
								<a href="#" class="image float-left"><img src="img/header-cart/1.jpg" alt="" /></a>
							...
							<li>
								<a href="#" class="image float-left"><img src="img/header-cart/2.jpg" alt="" /></a>
								<div class="content fix">
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				...
				<h1>下笔如有神</h1>--%>
				<h1>&nbsp;</h1>
				<!--<h5><a href="#" style="color: whitesmoke">看看这本</a></h5>-->
			</div>
		</div>
	</div>
</div>
										...
										<div class="top fix">
											<div style="text-align: center;">
												<div class="book_info">
													...
													<div class="price book_author">
														<span class="sp1">作者:</span>
														<span class="sp2">霍金</span>
													</div>

													<div class="price book_sales">
														<span class="sp1">销量:</span>
														<span class="sp2">23</span>
													</div>
													<div class="price book_amount">
											...
											<p class="price float-right">$ 256</p>-->
												<h3><a href="#">建议零售价：</a></h3>
												<p class="price ">$ 30</p>
												<div class="price book_add">
													<button>加入购物车</button>
												</div>
											</div>
										</div>
							...
							<!--<div class="col-lg-4 col-sm-6">
								<div class="sin-product">
									...
									<div class="pro-image">
										...
										&lt;!&ndash; Product Hover Content &ndash;&gt;
										<div class="pro-hover fix" style="background-image: url('img/product/5.jpg');">
											&lt;!&ndash; Product Hover Action &ndash;&gt;
											<div class="pro-hover-action animated text-center">
												<button class="add-cart pro-action"><i class="mo-cart"></i></button>
												<a href="#quick-view" class="quick-view pro-action" data-toggle="modal"><i class="mo-eye"></i></a>
							...
							<div class="col-lg-4 col-sm-6">
								<div class="sin-product">
									...
									<div class="pro-image">
										...
										<span class="pro-label great-deal">great deals</span>
										&lt;!&ndash; Product Hover Content &ndash;&gt;
										<div class="pro-hover fix" style="background-image: url('img/product/9.jpg');">
											&lt;!&ndash; Product Hover Action &ndash;&gt;
											<div class="pro-hover-action animated text-center">
												<button class="add-cart pro-action"><i class="mo-cart"></i></button>
												<a href="#quick-view" class="quick-view pro-action" data-toggle="modal"><i class="mo-eye"></i></a>
							...
							<div class="col-lg-4 col-sm-6">
								<div class="sin-product">
									...
									<div class="pro-image">
										...
										&lt;!&ndash; Product Hover Content &ndash;&gt;
										<div class="pro-hover fix" style="background-image: url('img/product/13.jpg');">
											&lt;!&ndash; Product Hover Action &ndash;&gt;
											<div class="pro-hover-action animated text-center">
												<button class="add-cart pro-action"><i class="mo-cart"></i></button>
												<a href="#quick-view" class="quick-view pro-action" data-toggle="modal"><i class="mo-eye"></i></a>
						...
						<div class="tab-pane row" id="list-view">
							<div class="sin-product-list fix">
								<div class="list-pro-image col-lg-4 col-sm-5 col-xs-12">
									<a href="#"><img src="img/list-product/1.jpg" alt="product" /></a>
							...
							<div class="sin-product-list fix">
								<div class="list-pro-image col-lg-4 col-sm-5 col-xs-12">
									<a href="#"><img src="img/list-product/2.jpg" alt="product" /></a>
								</div>
								<div class="list-pro-content col-lg-6 col-sm-7 col-xs-12">
									<h2><a href="#">Minrova Sleep Wear</a></h2>
									<div class="ratting fix">
										<i class="mo-star star active"></i>
										<i class="mo-star star active"></i>
										<i class="mo-star star active"></i>
									...
									<h3 class="list-pro-price">$ 128</h3>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod aliqua. Ut enim ad minim veniam,</p>
									<p>Quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
									<div class="list-pro-action">
										<button class="add-cart list-action"><i class="mo-cart"></i><span>Add to Cart</span></button>
							...
							<div class="sin-product-list fix">
								<div class="list-pro-image col-lg-4 col-sm-5 col-xs-12">
									<a href="#"><img src="img/list-product/3.jpg" alt="product" /></a>
								</div>
								<div class="list-pro-content col-lg-6 col-sm-7 col-xs-12">
									<h2><a href="#">Print Cutout Top</a></h2>
									<div class="ratting fix">
										<i class="mo-star star active"></i>
										<i class="mo-star star active"></i>
										<i class="mo-star star active"></i>
									...
									<h3 class="list-pro-price">$ 256</h3>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod aliqua. Ut enim ad minim veniam,</p>
									<p>Quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
									<div class="list-pro-action">
										<button class="add-cart list-action"><i class="mo-cart"></i><span>Add to Cart</span></button>
							...
							<div class="sin-product-list fix">
								<div class="list-pro-image col-lg-4 col-sm-5 col-xs-12">
									<a href="#"><img src="img/list-product/4.jpg" alt="product" /></a>
								</div>
								<div class="list-pro-content col-lg-6 col-sm-7 col-xs-12">
									<h2><a href="#">Shanos Matte Blue</a></h2>
									<div class="ratting fix">
										<i class="mo-star star active"></i>
										<i class="mo-star star active"></i>
										<i class="mo-star star active"></i>
									...
									<h3 class="list-pro-price">$ 356</h3>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod aliqua. Ut enim ad minim veniam,</p>
									<p>Quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
									<div class="list-pro-action">
										<button class="add-cart list-action"><i class="mo-cart"></i><span>Add to Cart</span></button>
							...
							<div class="sin-product-list fix">
								<div class="list-pro-image col-lg-4 col-sm-5 col-xs-12">
									<a href="#"><img src="img/list-product/5.jpg" alt="product" /></a>
								</div>
								<div class="list-pro-content col-lg-6 col-sm-7 col-xs-12">
									<h2><a href="#">Popline Tops</a></h2>
									<div class="ratting fix">
										<i class="mo-star star active"></i>
										<i class="mo-star star active"></i>
										<i class="mo-star star active"></i>
									...
									<h3 class="list-pro-price">$ 238</h3>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod aliqua. Ut enim ad minim veniam,</p>
									<p>Quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
									<div class="list-pro-action">
										<button class="add-cart list-action"><i class="mo-cart"></i><span>Add to Cart</span></button>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-2 col-sm-3">
				<div class="section-title-2"><h1>其他书城</h1></div>
			</div>
				...
				<div class="pro-info-container fix">
					...
					<div class="product-image col-md-6">
						...
						<ul class="pro-image-tab-list">
							<li><a href="#image-1" data-toggle="tab"><img src="img/pro-details/1.jpg" alt="" /></a></li>
							<li class="active"><a href="#image-2" data-toggle="tab"><img src="img/pro-details/2.jpg" alt="" /></a></li>
							<li><a href="#image-3" data-toggle="tab"><img src="img/pro-details/3.jpg" alt="" /></a></li>
							<li><a href="#image-4" data-toggle="tab"><img src="img/pro-details/4.jpg" alt="" /></a></li>
						</ul>
					</div>
				</div>
			</div>
